    ...
    public class NoticeService : INoticeService
    {
        ...
        public virtual string SaveOrUpdate(string json)
        {
            using (ISession sess = HbmSessionFactory.OpenSession())
            {
                ...
                Notice entity = JsonSerializerHelper.JsonToEntity<Notice>(json);
        ...
        public virtual string DeleteById(int id)
        {
            using (ISession sess = HbmSessionFactory.OpenSession())
            {
                ...
                try
                {
                    Notice entity = sess.Load<Notice>(id);
                    sess.Delete(entity);
                    tx.Commit();
        ...
        public virtual string GetById(int id)
        {
            using (ISession sess = HbmSessionFactory.OpenSession())
            {
                try
                {
                    Notice entity = sess.Get<Notice>(id);
        ...
        public virtual string GetByHql(string hql)
        {
            using (ISession sess = HbmSessionFactory.OpenSession())
            {
                try
                {
                    Notice entity = sess.CreateQuery(hql).UniqueResult<Notice>();
        ...
        public virtual string GetListByHQL(string hql)
        {
            ...
            using (ISession sess = HbmSessionFactory.OpenSession())
            {
                try
                {
                    IList<Notice> ls = sess.CreateQuery(hql).List<Notice>();
        ...
        public virtual string GetListByHQLWithPaging(string condition)
        {
            ...
            try
            {
                ...
                //设置分页
                IList<Notice> ls = q.SetFirstResult(qc.FirstResult).SetMaxResults(qc.MaxResults).List<Notice>();
                //IList<T> ls = q.List<T>();
